...
- Admin-only: user management, supplier management, equipment management, QA level management, costing, labour rates & overtime, settings, activity log, **contact/customer info**, **job card creation/deletion**, **note deletion**
...
- **Settings page**: Non-admin users see only Appearance (dark mode) and Change PIN. Admin users see all cards (App Info, Current User, Printers, Security Settings, Job Folders, Data Backup, Server Connection). Labour rates & overtime live on their own admin page (`/labour-rates`), not on the Settings page.
