...
const ITEM_FIELD_REGEX = /^item_(\d+)_(number|qty|description|job_type|material|treatment)$/;
      ...
      if (itemMatch) {
        ...
        if (item) {
          ...
          if (prop === 'treatment') {
            ...
            const keyMap = { number: 'itemNumber', qty: 'qty', description: 'description', job_type: 'jobType', material: 'material' };
