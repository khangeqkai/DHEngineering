...
## Corpus Check
- 255 files · ~1,542,532 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1119 nodes · 2225 edges · 84 communities detected
...
- `JobCardList()` --calls--> `useJobCardColumnOrder()`  [INFERRED]
  client/src/components/JobCardList.jsx → /mnt/c/Users/khang/Code/Software/DHEngineering/jobcard-system/client/src/hooks/useJobCardColumnOrder.js
- `JobCardList()` --calls--> `useJobCardColumnVisibility()`  [INFERRED]
  client/src/components/JobCardList.jsx → /mnt/c/Users/khang/Code/Software/DHEngineering/jobcard-system/client/src/hooks/useJobCardColumnVisibility.js
...
Cohesion: 0.06
Nodes (36): CreatableTagSelect(), InlineSupplierForm(), blankCompany(), ContactManagement(), QALevelManagement(), SupplierManagement(), TagManagement(), blankPerson() (+28 more)

### Community 2 - "Community 2"
Cohesion: 0.08
Nodes (38): JobCardList(), penTabWithin(), getJobCardColumns(), JobCardListTable(), formatElapsed(), useActiveTimerIndicator(), useJobCardSort(), useMissingFilesIndicator() (+30 more)
...
Cohesion: 0.08
Nodes (30): EntityActivityLog(), formatAction(), formatChanges(), formatTarget(), getStatusBadgeClass(), isJobOverdue(), mergeColumnOrder(), normalizeHiddenColumns() (+22 more)

### Community 6 - "Community 6"
Cohesion: 0.07
Nodes (20): Layout(), Login(), SearchPage(), Settings(), UserManagement(), AuthProvider(), useAuth(), useInactivityTimer() (+12 more)
...
- **Thin community `Community 47`** (5 nodes): `seed-history.js`, `seed-history.js`, `seed-history.js`, `seedHistory()`, `seed-history.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 48`** (5 nodes): `seed-scenarios.js`, `seed-scenarios.js`, `seed-scenarios.js`, `buildScenarios()`, `seed-scenarios.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 49`** (5 nodes): `config.js`, `config.js`, `config.js`, `config.js`, `getOrCreateJwtSecret()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 50`** (5 nodes): `seed-tags.js`, `nameToValue()`, `seed-tags.js`, `seed-tags.js`, `seed-tags.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 51`** (5 nodes): `jobcard.js`, `jobcard.js`, `jobcard.js`, `getAssigneesForJobcards()`, `jobcard.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 52`** (5 nodes): `maintenance.js`, `maintenanceGuard()`, `setMaintenance()`, `maintenance.js`, `maintenance.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 53`** (5 nodes): `jobcard-costing.js`, `jobcard-costing.js`, `jobcard-costing.js`, `auditValue()`, `jobcard-costing.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 54`** (5 nodes): `logger.js`, `logger.js`, `logger.js`, `logger.js`, `requestLogger()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 59`** (4 nodes): `customer-format.js`, `toCompanyApi()`, `toContactApi()`, `customer-format.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 61`** (3 nodes): `rebuild-native.js`, `rebuild-native.js`, `resolveElectronVersion()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 81`** (3 nodes): `TimezoneCard.jsx`, `TimezoneCard()`, `TimezoneCard.jsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 83`** (3 nodes): `addMissingColumns()`, `columnMigrations.js`, `columnMigrations.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 84`** (3 nodes): `operations.js`, `getLatestNotesForJobcards()`, `operations.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 85`** (3 nodes): `companies.js`, `normalizeEmpty()`, `companies.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `useAuth()` connect `Community 6` to `Community 2`, `Community 3`, `Community 4`, `Community 5`?**
