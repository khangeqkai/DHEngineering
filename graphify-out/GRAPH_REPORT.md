...
## Corpus Check
- 239 files · ~1,527,719 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 829 nodes · 1351 edges · 58 communities detected
...
Cohesion: 0.06
Nodes (31): JobCardList(), getJobCardColumns(), Layout(), Login(), Settings(), UserManagement(), AuthProvider(), useAuth() (+23 more)
...
Cohesion: 0.22
Nodes (18): JobCardListTable(), buildJobCardWorkbook(), buildSheet(), exportActivityLog(), exportContacts(), exportEquipment(), exportJobCardList(), exportJobCardsFull() (+10 more)
...
- **Thin community `Community 45`** (4 nodes): `jobcard-time-entries.js`, `normalizeEmpty()`, `readFlag()`, `jobcard-time-entries.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 46`** (4 nodes): `machines.js`, `normalizeEmpty()`, `toResponseFormat()`, `machines.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
