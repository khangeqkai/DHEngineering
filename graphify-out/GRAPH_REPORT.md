...
## Corpus Check
- 132 files · ~89,830 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 581 nodes · 819 edges · 23 communities detected
...
Cohesion: 0.05
Nodes (39): JobCardList(), mergeColumnOrder(), getJobCardColumns(), useJobCardListDensity(), Layout(), Login(), Settings(), UserManagement() (+31 more)

### Community 2 - "Community 2"
Cohesion: 0.06
Nodes (22): ContactManagement(), QALevelManagement(), SupplierManagement(), TagManagement(), useConfirmDialog(), invalidateTagCache(), useTags(), formatDueDate() (+14 more)
...
Cohesion: 0.09
Nodes (16): JobCardModal(), validateJobCardForm(), formatFileDate(), getDefaultCostingForm(), getDefaultFormData(), getDefaultTimeEntryForm(), mapLineItemFromApi(), useActivityLog() (+8 more)
...
- **Thin community `Community 7`** (14 nodes): `hardware.js`, `HardwareService`, `.capturePhoto()`, `.checkElectron()`, `.closeCamera()`, `.constructor()`, `.getAppInfo()`, `.getCameras()`, `.getPrinters()`, `.getScanners()`, `.openCamera()`, `.print()`, `.printToPDF()`, `.scan()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 10`** (11 nodes): `Waves.jsx`, `Grad`, `.constructor()`, `.dot2()`, `Noise`, `.constructor()`, `.fade()`, `.lerp()`, `.perlin2()`, `.seed()`, `Waves()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `useConfirmDialog()` connect `Community 2` to `Community 1`, `Community 4`, `Community 5`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `useAuth()` connect `Community 1` to `Community 9`, `Community 4`, `Community 5`?**
