...
## Corpus Check
- 198 files · ~1,476,003 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 839 nodes · 1360 edges · 48 communities detected
...
Cohesion: 0.06
Nodes (24): CreatableTagSelect(), ContactManagement(), QALevelManagement(), SupplierManagement(), TagManagement(), UserManagement(), useConfirmDialog(), invalidateTagCache() (+16 more)
