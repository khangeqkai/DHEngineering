...
## Corpus Check
- 132 files · ~87,319 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 580 nodes · 818 edges · 23 communities detected
...
Cohesion: 0.07
Nodes (15): invalidateTagCache(), useTags(), formatDueDate(), JobIdentityStrip(), statusToken(), formatFileSize(), makeEmptyTreatment(), useJobSearch() (+7 more)
...
- **Why does `useAuth()` connect `Community 2` to `Community 1`, `Community 11`, `Community 4`, `Community 6`?**
