...
## Corpus Check
- 142 files · ~115,232 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 766 nodes · 1156 edges · 31 communities detected
...
Cohesion: 0.05
Nodes (44): JobCardList(), mergeColumnOrder(), getJobCardColumns(), useJobCardListDensity(), Layout(), Login(), Settings(), AuthProvider() (+36 more)
...
Cohesion: 0.05
Nodes (18): CalendarPicker(), toDateString(), isTopModal(), pushModal(), removeModal(), JobFilesMenu(), JobPaperworkHub(), LineItemFilesMenu() (+10 more)
...
Cohesion: 0.06
Nodes (26): getSettings(), peekNextJobNumber(), recordHistory(), checkInterruptedRestore(), ensureBuiltInStandardLevel(), initializeDatabase(), runMigrations(), autoAssignWorker() (+18 more)
...
Cohesion: 0.5
Nodes (7): discardBrowser(), getBrowser(), inElectron(), launchBrowser(), renderHtmlToPdf(), renderWithElectron(), renderWithPuppeteer()
...
- **Thin community `Community 23`** (6 nodes): `checkLoginRateLimit()`, `clearLoginFailures()`, `cooldownMsForCount()`, `normalizeEmpty()`, `recordLoginFailure()`, `auth.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 27`** (4 nodes): `getSupplierWithTags()`, `normalizeEmpty()`, `toApiFormat()`, `suppliers.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 28`** (4 nodes): `fileValidation.js`, `assertMatchesExtension()`, `decodeBase64Strict()`, `matchesSignature()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
