...
## Corpus Check
- 136 files · ~100,367 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 618 nodes · 873 edges · 28 communities detected
...
Cohesion: 0.06
Nodes (21): ContactManagement(), QALevelManagement(), SupplierManagement(), TagManagement(), UserManagement(), useConfirmDialog(), invalidateTagCache(), useTags() (+13 more)
