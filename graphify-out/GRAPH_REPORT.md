...
## Corpus Check
- 132 files · ~87,309 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 579 nodes · 815 edges · 23 communities detected
...
Cohesion: 0.07
Nodes (31): ContactManagement(), QALevelManagement(), Settings(), SupplierManagement(), TagManagement(), UserManagement(), useConfirmDialog(), useSettings() (+23 more)

### Community 2 - "Community 2"
Cohesion: 0.06
Nodes (24): JobCardList(), mergeColumnOrder(), getJobCardColumns(), useJobCardListDensity(), Layout(), Login(), ActionBadge(), fmt() (+16 more)
...
Cohesion: 0.12
Nodes (23): getSettings(), peekNextJobNumber(), recordHistory(), initializeDatabase(), runMigrations(), buildStorageFilename(), resolveCategoryFolder(), resolveCustomerPropertyPath() (+15 more)
...
- **Thin community `Community 11`** (11 nodes): `Waves.jsx`, `Grad`, `.constructor()`, `.dot2()`, `Noise`, `.constructor()`, `.fade()`, `.lerp()`, `.perlin2()`, `.seed()`, `Waves()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 19`** (6 nodes): `camelToSnake()`, `convertKeysToCamel()`, `copyDirRecursive()`, `getTableColumns()`, `snakeToCamel()`, `settings.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 21`** (5 nodes): `CostingTab.jsx`, `CostingTab()`, `formatElapsed()`, `LiveElapsed()`, `TimeEntriesSection()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
